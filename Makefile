...
IMG ?= ibm-metering-multicloudui-operator
...
bundle:
	...
	-mkdir bundle
	rm -rf bundle/*
	cp -r deploy/olm-catalog/ibm-metering-multicloudui-operator/${CSV_VERSION}/* bundle/
	cp deploy/olm-catalog/ibm-metering-multicloudui-operator/ibm-metering-multicloudui-operator.package.yaml bundle/

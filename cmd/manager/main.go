...
import (
	...
	"github.com/ibm/ibm-metering-multicloudui-operator/pkg/apis"
	"github.com/ibm/ibm-metering-multicloudui-operator/pkg/controller"
	"github.com/ibm/ibm-metering-multicloudui-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "ibm-metering-multicloudui-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}

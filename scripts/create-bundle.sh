...
VERSION=3.6.0
cp -p deploy/olm-catalog/ibm-metering-multicloudui-operator/ibm-metering-multicloudui-operator.package.yaml bundle/
cp -p deploy/olm-catalog/ibm-metering-multicloudui-operator/$VERSION/*yaml bundle/
...
cd bundle || exit
zip ibm-metering-multicloudui-metadata ./*.yaml
cd ..
